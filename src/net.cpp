...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "meta1coin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"meta1cointools.com", "dnsseed.meta1cointools.com"},
    {"meta1coinpool.org", "dnsseed.meta1coinpool.org"},
    {"23.111.156.202", "23.111.152.206"},

    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"meta1cointools.com", "testnet-seed.meta1cointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. meta1coin is probably already running."), addrBind.ToString().c_str());
        else
